...
WSGI_APPLICATION = 'EmcoCrud.wsgi.application'
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'victordanielmar91@gmail.com'
EMAIL_HOST_PASSWORD = 'uayo mfvi fodt ohan'
...
LOGOUT_REDIRECT_URL = 'login'  # 'login' es el nombre de la URL de login en tus URLs
